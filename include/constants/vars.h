...
#define VAR_ASK_TO_LEAVE                                 0x404E // Unused Var
...
#define VAR_FISHERMANS_DREAM_STATE                       0x40FE // Dream Emerald
#define VAR_FISHERMANS_DREAM_TICKETS                     0x40FF // Dream Emerald
