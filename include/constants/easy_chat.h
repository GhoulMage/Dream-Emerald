...
#define EC_WORD_SOUND          (EC_GROUP_ENDINGS << 9) | 0x26
#define EC_WORD_MAYBE          (EC_GROUP_ENDINGS << 9) | 0x27
#define EC_WORD_ABOUT          (EC_GROUP_ENDINGS << 9) | 0x28
#define EC_WORD_OVER           (EC_GROUP_ENDINGS << 9) | 0x29
#define EC_WORD_IT             (EC_GROUP_ENDINGS << 9) | 0x2a
#define EC_WORD_ALL            (EC_GROUP_ENDINGS << 9) | 0x2b
#define EC_WORD_FOR            (EC_GROUP_ENDINGS << 9) | 0x2c
#define EC_WORD_ON             (EC_GROUP_ENDINGS << 9) | 0x2d
#define EC_WORD_OFF            (EC_GROUP_ENDINGS << 9) | 0x2e
#define EC_WORD_AS             (EC_GROUP_ENDINGS << 9) | 0x2f
#define EC_WORD_TO             (EC_GROUP_ENDINGS << 9) | 0x30
#define EC_WORD_WITH           (EC_GROUP_ENDINGS << 9) | 0x31
#define EC_WORD_BETTER         (EC_GROUP_ENDINGS << 9) | 0x32
#define EC_WORD_EVER           (EC_GROUP_ENDINGS << 9) | 0x33
#define EC_WORD_SINCE          (EC_GROUP_ENDINGS << 9) | 0x34
#define EC_WORD_OF             (EC_GROUP_ENDINGS << 9) | 0x35
#define EC_WORD_BELONGS_TO     (EC_GROUP_ENDINGS << 9) | 0x36
#define EC_WORD_AT             (EC_GROUP_ENDINGS << 9) | 0x37
#define EC_WORD_IN             (EC_GROUP_ENDINGS << 9) | 0x38
#define EC_WORD_OUT            (EC_GROUP_ENDINGS << 9) | 0x39
#define EC_WORD_TOO            (EC_GROUP_ENDINGS << 9) | 0x3a
#define EC_WORD_LIKE           (EC_GROUP_ENDINGS << 9) | 0x3b
#define EC_WORD_DID            (EC_GROUP_ENDINGS << 9) | 0x3c
#define EC_WORD_DIDN_T         (EC_GROUP_ENDINGS << 9) | 0x3d
#define EC_WORD_DOESN_T        (EC_GROUP_ENDINGS << 9) | 0x3e
#define EC_WORD_WITHOUT        (EC_GROUP_ENDINGS << 9) | 0x3f
#define EC_WORD_AFTER          (EC_GROUP_ENDINGS << 9) | 0x40
#define EC_WORD_BEFORE         (EC_GROUP_ENDINGS << 9) | 0x41
#define EC_WORD_WHILE          (EC_GROUP_ENDINGS << 9) | 0x42
#define EC_WORD_THAN           (EC_GROUP_ENDINGS << 9) | 0x43
#define EC_WORD_ONCE           (EC_GROUP_ENDINGS << 9) | 0x44
#define EC_WORD_ANYWHERE       (EC_GROUP_ENDINGS << 9) | 0x45
