...
#define DOUBLE_MON(party) { .DoubleMon = party }, .partySize = ARRAY_COUNT(party), .partyFlags = F_TRAINER_PARTY_CUSTOM_MOVESET | F_TRAINER_PARTY_HELD_ITEM | F_TRAINER_PARTY_RANDOM
...
union TrainerMonPtr
{
    ...
    const struct TrainerMonDouble *DoubleMon;
};
