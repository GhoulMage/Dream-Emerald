...
static const u16 sSpeciesToHoennPokedexNum[NUM_SPECIES - 1] =
{
    ...
    SPECIES_TO_HOENN(RALTSD),
    SPECIES_TO_HOENN(KIRLIAD),
    SPECIES_TO_HOENN(GARDEVOIRD),
...
static const u16 sSpeciesToNationalPokedexNum[NUM_SPECIES - 1] =
{
    ...
    SPECIES_TO_NATIONAL(RALTSD),
    SPECIES_TO_NATIONAL(KIRLIAD),
    SPECIES_TO_NATIONAL(GARDEVOIRD),
...
#endif
{
    ...
    [SPECIES_ADOKANA - 1]       = ANIM_V_SHAKE_TWICE,
    ...
    [SPECIES_RALTSD - 1]        = ANIM_V_SQUISH_AND_BOUNCE_SLOW,
    [SPECIES_KIRLIAD - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_GARDEVOIRD - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
