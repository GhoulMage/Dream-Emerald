...
static const u8 sSpeciesToBackAnimSet[NUM_SPECIES] =
{
    ...
    [SPECIES_ADOKANA]    = BACK_ANIM_V_SHAKE,
    ...
    [SPECIES_RALTSD]     = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_KIRLIAD]    = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_GARDEVOIRD] = BACK_ANIM_SHRINK_GROW_VIBRATE,
