        ...
        for (i = 0; i < monsCount; i++)
        {
            ...
            case F_TRAINER_PARTY_CUSTOM_MOVESET | F_TRAINER_PARTY_HELD_ITEM | F_TRAINER_PARTY_RANDOM:
            {
                ...
                case 1:
                    ...
                    if(partyData[i].mon1.shiny == TRUE)
                        CreateMon(&party[i], partyData[i].mon1.species, partyData[i].mon1.lvl, fixedIV, TRUE, personalityValue, OT_ID_RANDOM_SHINY, 0);
                    else
                    ...
                    if(&partyData[i].mon1.ability != ABILITY_NONE){
                        u32 value;
                        if(GetAbilityBySpecies(partyData[i].mon1.species, 0) == partyData[i].mon1.ability){
                            value = personalityValue & 0;
                        }else if(GetAbilityBySpecies(partyData[i].mon1.species, 1) == partyData[i].mon1.ability) {
                            value = personalityValue & 1;
                        } else if(GetAbilityBySpecies(partyData[i].mon1.species, 2) == partyData[i].mon1.ability){
                            value = personalityValue & 2;
                        }
                ...
                default:
                    ...
                    if(partyData[i].mon2.shiny == TRUE)
                        CreateMon(&party[i], partyData[i].mon2.species, partyData[i].mon2.lvl, fixedIV, TRUE, personalityValue, OT_ID_RANDOM_SHINY, 0);
                    else
                    ...
                    if(&partyData[i].mon2.ability != ABILITY_NONE){
                        u32 value;
                        if(GetAbilityBySpecies(partyData[i].mon2.species, 0) == partyData[i].mon2.ability){
                            value = personalityValue & 0;
                        }else if(GetAbilityBySpecies(partyData[i].mon2.species, 1) == partyData[i].mon2.ability) {
                            value = personalityValue & 1;
                        } else if(GetAbilityBySpecies(partyData[i].mon2.species, 2) == partyData[i].mon2.ability){
                            value = personalityValue & 2;
                        }
