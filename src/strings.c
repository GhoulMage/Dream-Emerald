...
const u8 gText_CantSwitchItemMail[] = _("Cannot switch an item with a MAIL.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_HMMovesCantBeForgotten2[] = _("Can't be forgotten\nnow.");
...
const u8 gText_RunMode[] = _("RUN STYLE");
...
const u8 gText_RunModeAuto[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}AUTO");
const u8 gText_RunModeHold[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}HOLD");
...
const u8 gText_MoveOkBack[] = _("{DPAD_NONE}MOVE  {R_BUTTON}CHANGE CASE  {A_BUTTON}OK  {B_BUTTON}BACK");
...
const u8 gText_CrazyScientistCallDesc[] = _("WEIRD & LOUD");
...
const u8 gText_CrazyScientistCallName[] = _("SCIENTIST");
