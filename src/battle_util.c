...
{//                   Defender -->
 //  Attacker         Normal  Fighting Flying  Poison  Ground   Rock    Bug     Ghost   Steel  Mystery  Fire   Water   Grass  Electric Psychic   Ice   Dragon   Dark   Fairy   Sound
    ...
    [TYPE_FIGHTING] = {X(2.0), ______, X(0.5), X(0.5), ______, X(2.0), ______, X(0.0), X(2.0), ______, ______, ______, ______, ______, X(0.5), X(2.0), ______, X(2.0), X(0.5), X(0.5)},
    ...
    [TYPE_POISON]   = {______, ______, ______, X(0.5), X(0.5), X(0.5), X(0.5), X(0.5), X(0.0), ______, ______, ______, X(2.0), ______, ______, ______, ______, ______, X(2.0), X(0.5)},
    ...
    [TYPE_ROCK]     = {______, ______, X(2.0), ______, X(0.5), ______, X(2.0), ______, X(0.5), ______, X(2.0), ______, ______, ______, ______, X(2.0), ______, ______, ______, ______},
    [TYPE_BUG]      = {______, ______, X(0.5), ______, ______, ______, ______, ______, X(0.5), ______, X(0.5), ______, X(2.0), ______, X(2.0), ______, ______, X(2.0), X(2.0), ______},
    ...
    [TYPE_STEEL]    = {______, ______, ______, ______, ______, X(2.0), ______, X(2.0), X(0.5), ______, X(0.5), X(0.5), ______, X(0.5), ______, ______, ______, ______, ______, ______},
    ...
    [TYPE_FIRE]     = {______, ______, ______, ______, ______, X(0.5), X(2.0), ______, X(2.0), ______, X(0.5), X(0.5), X(2.0), ______, ______, ______, X(0.5), ______, ______, ______},
    [TYPE_WATER]    = {______, ______, ______, ______, X(2.0), X(2.0), ______, ______, ______, ______, X(2.0), X(0.5), X(0.5), ______, ______, X(0.5), X(0.5), ______, ______, X(2.0)},
    ...
    [TYPE_PSYCHIC]  = {______, X(2.0), ______, X(2.0), ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, X(0.5), ______, ______, X(0.0), ______, X(0.5)},
    [TYPE_ICE]      = {______, ______, X(2.0), ______, ______, X(2.0), ______, ______, X(2.0), ______, ______, ______, X(2.0), ______, ______, X(0.5), X(2.0), ______, ______, X(2.0)},
    [TYPE_DRAGON]   = {______, ______, ______, ______, X(0.5), ______, X(0.5), ______, X(0.5), ______, ______, ______, ______, ______, ______, ______, X(2.0), ______, X(0.0), ______},
    [TYPE_DARK]     = {______, X(0.5), ______, ______, ______, ______, ______, X(2.0), ______, ______, ______, ______, ______, ______, X(2.0), ______, ______, X(0.5), X(2.0), ______},
    ...
    [TYPE_SOUND]    = {______, X(2.0), ______, X(0.5), ______, X(2.0), X(0.0), ______, ______, ______, ______, ______, ______, ______, X(2.0), X(0.5), ______, ______, ______, X(0.5)}
};
...
u32 TrySetCantSelectMoveBattleScript(u32 battler)
{
    ...
    if (DYNAMAX_BYPASS_CHECK && gBattleStruct->zmove.toBeUsed[gBattlerAttacker] == MOVE_NONE && gDisableStructs[battler].throatChopTimer != 0 && MoveIsSonic(move))
    {
        gCurrentMove = move;
        if (gBattleTypeFlags & BATTLE_TYPE_PALACE)
        {
...
u8 CheckMoveLimitations(u32 battler, u8 unusableMoves, u16 check)
{
    ...
    for (i = 0; i < MAX_MON_MOVES; i++)
    {
        ...
        // Belch
            ...
            unusableMoves |= gBitTable[i];
        // Throat Chop
        else if (check & MOVE_LIMITATION_THROAT_CHOP && gDisableStructs[battler].throatChopTimer && MoveHasSound(move))
            unusableMoves |= gBitTable[i];
        // Stuff Cheeks
...
u8 AtkCanceller_UnableToUseMove(u32 moveType)
{
    ...
    do
    {
        ...
        case CANCELLER_THROAT_CHOP:
            if (gBattleStruct->zmove.toBeUsed[gBattlerAttacker] == MOVE_NONE && gDisableStructs[gBattlerAttacker].throatChopTimer && MoveIsSonic(gCurrentMove))
            {
    ...
    case ABILITYEFFECT_MOVES_BLOCK: // 2
        {
            ...
            if ((gLastUsedAbility == ABILITY_SOUNDPROOF && MoveIsSonic(move) && !(moveTarget & MOVE_TARGET_USER))
        ...
        case ABILITY_EFFECT_SPORE:
             ...
             && GetBattlerHoldEffect(gBattlerAttacker, TRUE) != HOLD_EFFECT_SAFETY_GOGGLES)
            {
                ...
                if (!(gMoveResultFlags & MOVE_RESULT_NO_EFFECT)
                 ...
                 && IsMoveMakingContact(move, gBattlerAttacker)
                 && (Random() % 3) == 0
                 && CanBePutToSleep(gBattlerAttacker))
                {
...
static inline u32 CalcMoveBasePower(u32 move, u32 battlerAtk, u32 battlerDef, u32 abilityDef, u32 weather)
{
    ...
    case EFFECT_EXPANDING_FORCE:
        if (IsBattlerTerrainAffected(battlerAtk, STATUS_FIELD_PSYCHIC_TERRAIN))
            basePower = uq4_12_multiply(basePower, UQ_4_12(1.3)); //Nerf
        break;
