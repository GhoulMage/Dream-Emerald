...
} static const sTrainerClassesAndMusic[] =
{
    ...
    {TRAINER_CLASS_MAGMA_ADMIN_F, TRAINER_ENCOUNTER_MUSIC_MAGMA},
    {TRAINER_CLASS_MAGMA_ADMIN_M, TRAINER_ENCOUNTER_MUSIC_MAGMA},
    ...
    {TRAINER_CLASS_SOCIALITE, TRAINER_ENCOUNTER_MUSIC_RICH},
    {TRAINER_CLASS_ARTIST, TRAINER_ENCOUNTER_MUSIC_FEMALE},
};
