...
const u32 gMoveTypes_Pal0[] = INCBIN_U32("graphics/types/move_types0.gbapal.lz");
const u32 gMoveTypes_Pal1[] = INCBIN_U32("graphics/types/move_types1.gbapal.lz");
...
const u8 gMenuInfoElements_Gfx2[] = INCBIN_U8("graphics/interface/menu_info_2.4bpp");
const u16 gMenuInfoElements_2_Pal1[] = INCBIN_U16("graphics/interface/menu_info_2_pal_1.gbapal");
