...
const u8 *const gMonIconTable[] =
{
    ...
    [SPECIES_ADOKANA] = gMonIcon_Adokana,
    ...
    [SPECIES_RALTSD] = gMonIcon_RaltsD,
    [SPECIES_KIRLIAD] = gMonIcon_KirliaD,
    [SPECIES_GARDEVOIRD] = gMonIcon_GardevoirD,
    ...
    [SPECIES_ARCEUS_SOUND] =        gMonIcon_Arceus,
#endif
#if P_GEN_5_POKEMON == TRUE
