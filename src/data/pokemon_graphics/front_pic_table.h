const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(RALTSD, gMonFrontPic_RaltsD),
    SPECIES_SPRITE(KIRLIAD, gMonFrontPic_KirliaD),
    SPECIES_SPRITE(GARDEVOIRD, gMonFrontPic_GardevoirD),
    ...
    SPECIES_SPRITE(ADOKANA, gMonFrontPic_Adokana),
#endif
