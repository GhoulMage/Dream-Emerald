const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(RALTSD, gMonBackPic_RaltsD),
    SPECIES_SPRITE(KIRLIAD, gMonBackPic_KirliaD),
    SPECIES_SPRITE(GARDEVOIRD, gMonBackPic_GardevoirD),
    ...
    SPECIES_SPRITE(ADOKANA, gMonBackPic_Adokana),
#endif
    ...
    SPECIES_SPRITE(ARCEUS_SOUND, gMonBackPic_Arceus),
#endif
