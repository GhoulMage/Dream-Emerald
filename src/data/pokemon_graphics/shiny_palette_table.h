const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(RALTSD, gMonShinyPalette_RaltsD),
    SPECIES_SHINY_PAL(KIRLIAD, gMonShinyPalette_KirliaD),
    SPECIES_SHINY_PAL(GARDEVOIRD, gMonShinyPalette_GardevoirD),
    ...
    SPECIES_SHINY_PAL(ADOKANA, gMonShinyPalette_Adokana),
#endif
    ...
    SPECIES_SHINY_PAL(ARCEUS_SOUND, gMonShinyPalette_ArceusSound),
#endif
#if P_GEN_5_POKEMON == TRUE
