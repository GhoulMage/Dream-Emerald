const struct BattleMove gBattleMoves[MOVES_COUNT_Z] =
{
    ...
    [MOVE_ROAR] =
    {
        ...
        .pp = 20,
        .secondaryEffectChance = 0,
        .target = MOVE_TARGET_BOTH, //Sound Hits Most Foes
        .priority = -6,
        .split = SPLIT_STATUS,
        .zMovePower = 0,
        .zMoveEffect = Z_EFFECT_DEF_UP_1,
    ...
    [MOVE_SONIC_BOOM] = //TODO: Quick attack effect, super-effective on Sound Types
    {
    ...
    [MOVE_UPROAR] =
    {
        ...
        .pp = 10,
        .secondaryEffectChance = 100,
        .target = MOVE_TARGET_FOES_AND_ALLY, //Sound Hits Most Foes
        .priority = 0,
        .flags = FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_KINGS_ROCK_AFFECTED,
        .split = SPLIT_SPECIAL,
        .zMoveEffect = Z_EFFECT_NONE,
    ...
    [MOVE_HYPER_VOICE] = //TODO: Add a normal move like this
    {
        .effect = EFFECT_HIT,
        .power = 90,
        .type = TYPE_SOUND,
