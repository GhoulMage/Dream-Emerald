...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    [SPECIES_BIDOOF] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FIELD),
        .abilities = { ABILITY_SIMPLE, ABILITY_UNAWARE, ABILITY_IMMENSE_FANGS },
        .bodyColor = BODY_COLOR_BROWN,
...
#define MOTHIM_SPECIES_INFO                                                 \
    ...
    [SPECIES_STUNKY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_STENCH, ABILITY_NOXIOUS, ABILITY_AFTERMATH },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_HIPPOPOTAS] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SAND_STREAM, ABILITY_IMMENSE_FANGS, ABILITY_SAND_FORCE },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_CARNIVINE] =
    {
        ...
        .abilities = { ABILITY_LEVITATE, ABILITY_NONE, ABILITY_IMMENSE_FANGS },
        .bodyColor = BODY_COLOR_GREEN,
...
#define ARCEUS_SPECIES_INFO(type, typeName, iconPal)                        \
    ...
    // Dream Emerald
    [SPECIES_ARCEUS_SOUND]    = ARCEUS_SPECIES_INFO(TYPE_SOUND,    Sound,    0),
