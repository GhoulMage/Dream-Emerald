...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_GLIGAR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_HYPER_CUTTER, ABILITY_IMMENSE_FANGS, ABILITY_IMMUNITY },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_GLISCOR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_HYPER_CUTTER, ABILITY_IMMENSE_FANGS, ABILITY_POISON_HEAL },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_SNUBBULL] =
    {
        ...
        .abilities = { ABILITY_PANIC_ATTACK, ABILITY_RUN_AWAY, ABILITY_RATTLED },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_GRANBULL] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_FAIRY),
        .abilities = { ABILITY_PANIC_ATTACK, ABILITY_QUICK_FEET, ABILITY_IMMENSE_FANGS },
        .bodyColor = BODY_COLOR_PURPLE,
