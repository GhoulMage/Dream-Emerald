...
static const struct FormChange sArceusFormChangeTable[] = {
    ...
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ARCEUS_SOUND,    ITEM_SONIC_PLATE,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ARCEUS_SOUND,    ITEM_SOUNDIUM_Z,   ABILITY_MULTITYPE},
    {FORM_CHANGE_TERMINATOR},
};
