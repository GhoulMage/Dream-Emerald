...
#define SONIC_MOVE(typeArg) .type = TYPE_SOUND, \
    .sonicMove = TRUE, \
    .sonicMoveType = TYPE_##typeArg,
#define DANCE_MOVE(typeArg) .type = TYPE_SOUND, \
    .danceMove = TRUE, \
    .danceMoveType = TYPE_##typeArg,
...
const struct MoveInfo gMovesInfo[MOVES_COUNT_DYNAMAX] =
{
    ...
    [MOVE_RAIN_DANCE] =
    {
        .name = COMPOUND_STRING("Rain Prayer"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HOWL] =
    {
        ...
        .accuracy = 0,
        .pp = 40,
        .target = MOVE_TARGET_ALLY | MOVE_TARGET_USER,
        .priority = 0,
        .category = DAMAGE_CATEGORY_STATUS,
        .zMove = { .effect = Z_EFFECT_ATK_UP_1 },
        .snatchAffected = TRUE,
    ...
    [MOVE_PSYCHIC_INVERSION] =
    {
        ...
        .priority = 0,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .battleAnimScript = Move_PSYCHIC_INVERSION,
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_FLINCH,
            .chance = 30,
        }),
