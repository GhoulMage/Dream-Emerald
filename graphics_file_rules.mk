...
types := normal fight flying poison ground rock bug ghost steel mystery fire water grass electric psychic ice dragon dark fairy sound
...
$(TYPESGFXDIR)/move_types0.gbapal: $(TYPESGFXDIR)/move_types_1.gbapal \
                                  $(TYPESGFXDIR)/move_types_2.gbapal \
                                  $(TYPESGFXDIR)/move_types_3.gbapal
	@cat $^ >$@

$(TYPESGFXDIR)/move_types1.gbapal: $(TYPESGFXDIR)/move_types_4.gbapal
	@cat $^ >$@
